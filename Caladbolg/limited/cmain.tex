...
\begin{document}
	...
	\tableofcontents
	\chapter{李沐阳}
\section{Aho-Corasick Automaton} \cppcode{lmyy/Aho-Corasick Automaton.cpp}
\section{Bridges and Cut Vertices} \cppcode{lmyy/Bridges and Cut Vertices.cpp}
\section{Circle Intersection} \cppcode{lmyy/Circle Intersection.cpp}
\section{Counting Integral Points under Straight Line} \cppcode{lmyy/Counting Integral Points under Straight Line.cpp}
\section{Cross Points of Circles} \cppcode{lmyy/Cross Points of Circles.cpp}
\section{Cross Points of Line and Circle} \cppcode{lmyy/Cross Points of Line and Circle.cpp}
\section{Dominator Tree} \cppcode{lmyy/Dominator Tree.cpp}
\section{Graham Scanning Algorithm} \cppcode{lmyy/Graham Scanning Algorithm.cpp}
\section{Gray Code} \cppcode{lmyy/Gray Code.cpp}
\section{Half Plane Intersection} \cppcode{lmyy/Half Plane Intersection.cpp}
\section{Hungary} \cppcode{lmyy/Hungary.cpp}
\section{Intersecting Area of Circle and Polygon} \cppcode{lmyy/Intersecting Area of Circle and Polygon.cpp}
\section{Intersection of Line and Convex Hull} \cppcode{lmyy/Intersection of Line and Convex Hull.cpp}
\section{Kuhn-Munkres Algorithm} \cppcode{lmyy/Kuhn-Munkres Algorithm.cpp}
\section{Link Cut Tree} \cppcode{lmyy/Link Cut Tree.cpp}
\section{Maximal Matching in General Graphs} \cppcode{lmyy/Maximal Matching in General Graphs.cpp}
\section{Merge Split Treap} \cppcode{lmyy/Merge Split Treap.cpp}
\section{Modui Algorithm on Tree} \cppcode{lmyy/Modui Algorithm on Tree.cpp}
\section{Numerical Integration} \cppcode{lmyy/Numerical Integration.cpp}
\section{Planar Graph} \cppcode{lmyy/Planar Graph.cpp}
\section{Point Biconnected Component} \cppcode{lmyy/Point Biconnected Component.cpp}
\section{Pollard Rho Algorithm} \cppcode{lmyy/Pollard Rho Algorithm.cpp}
\section{Polygon Class} \cppcode{lmyy/Polygon Class.cpp}
\section{Simplex} \cppcode{lmyy/Simplex.cpp}
\section{Steiner Tree} \cppcode{lmyy/Steiner Tree.cpp}
\section{Strongly Connected Component} \cppcode{lmyy/Strongly Connected Component.cpp}
\section{Suffix Array} \cppcode{lmyy/Suffix Array.cpp}
\section{Zhu-Liu Algorithm} \cppcode{lmyy/Zhu-Liu Algorithm.cpp}
\section{Code} \cppcode{lmyy/Code.java}
\section{Common Formulas 2D} \cppcode{lmyy/Common Formulas 2D.cpp}
\section{Common Formulas 3D} \cppcode{lmyy/Common Formulas 3D.cpp}
\section{Convex Hull 2D} \cppcode{lmyy/Convex Hull 2D.cpp}
\section{Convex Hull 3D} \cppcode{lmyy/Convex Hull 3D.cpp}
\section{Maximal Weighted  Matching in General Graphs} \cppcode{lmyy/Maximal Weighted  Matching in General Graphs.cpp}
\section{Minimal Ball Cover} \cppcode{lmyy/Minimal Ball Cover.cpp}
\section{Minimal Circle Cover} \cppcode{lmyy/Minimal Circle Cover.cpp}
\section{Stoer Wagner Algorithm} \cppcode{lmyy/Stoer Wagner Algorithm.cpp}
\section{Virtual Tree} \cppcode{lmyy/Virtual Tree.cpp}
...
\section{Competition} \cppcode{lmyy/Competition.emacs}
