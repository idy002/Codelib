...
\begin{document}	
	...
	\chapter{司宇}
		...
		\section{SAM}
			\cppcode{ssy/SAM.cpp}
		\section{manacher}
			\cppcode{ssy/manacher.cpp}
		\section{中国剩余定理}
			\cppcode{ssy/中国剩余定理.cpp}
		\section{回文自动机}
			\cppcode{ssy/回文自动机.cpp}
		\section{多项式开方}
			\cppcode{ssy/多项式开方.cpp}
		\section{多项式求逆}
			\cppcode{ssy/多项式求逆.cpp}
		\section{广义SAM}
			\cppcode{ssy/广义SAM.cpp}
		\section{循环串最小表示}
			\cppcode{ssy/循环串最小表示.cpp}
		\section{扩展欧几里得}
			\cppcode{ssy/扩展欧几里得.cpp}
		\section{最大团搜索}
			\cppcode{ssy/最大团搜索.cpp}
		\section{极大团计数}
			\cppcode{ssy/极大团计数.cpp}
		\section{求原根}
			\cppcode{ssy/求原根.cpp}
		\section{线性递推多项式}
			\cppcode{ssy/线性递推多项式.cpp}
	\chapter{尧尧}
		\section{bcc}
			\cppcode{dyy/bcc.cpp}
		\section{fft}
			\cppcode{dyy/fft.cpp}
		\section{hungary}
			\cppcode{dyy/hungary.cpp}
		\section{kth.shortest.path}
			\cppcode{dyy/kth.shortest.path.cpp}
		\section{mobius}
			\cppcode{dyy/mobius.cpp}
		\section{ntt}
			\cppcode{dyy/ntt.cpp}
		\section{sam}
			\cppcode{dyy/sam.cpp}
		...
		\section{元根}
			\cppcode{dyy/元根.cpp}
		\section{决策单调性}
			\cppcode{dyy/决策单调性.cpp}
		\section{弦图}
			\cppcode{dyy/弦图.cpp}
		\section{树上莫队带修改}
			\cppcode{dyy/树上莫队带修改.cpp}
		\section{点分}
			\cppcode{dyy/点分.cpp}
		\section{集合幂级数}
			\cppcode{dyy/集合幂级数.cpp}
%	\chapter{图论}
%		\section{Hint}
